...
class CreateEnNonProfitCompanyInformations extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('en_non_profit_company_informations', function (Blueprint $table) {
            $table->id();
            $table->text('GOV');
    ...
    {
        Schema::dropIfExists('en_non_profit_company_informations');
    }
}
