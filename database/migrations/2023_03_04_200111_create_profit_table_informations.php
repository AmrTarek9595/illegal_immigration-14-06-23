...
class CreateProfitTableInformations extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('profit_table_informations', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreign('keys')
            ->references('id')->on('profit_company_informations')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('profit_table_informations');
    }
}
