...
class CreateProfitCompanyInformations extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('profit_company_informations', function (Blueprint $table) {
            $table->id();
            $table->text('GOV');
    ...
    {
        Schema::dropIfExists('profit_company_informations');
    }
}
